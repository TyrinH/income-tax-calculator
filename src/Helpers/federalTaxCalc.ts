export function getFederalTaxAmount(amount: number): number {
    const standardDeduction2021: number = 12550
    const income: number = amount - standardDeduction2021
    const firstBracket2021: number = 9950
    const firstBrackerMaxTax2021: number = 995
    const secondBracket2021: number = 40525
    const secondBracketMaxTax2021: number = 4863
    const thirdBracket2021: number = 86375
    const thirdBracketMaxTax2021: number = 19002.50
    const fourthBracket2021: number = 164925
    const fourthBracketMaxTax2021: number = 39582
    const fifthBracket2021: number = 209425
    const fifthBracketMaxTax2021: number = 67016
    const sixthBracket2021: number = 523600
    const sixthBracketMaxTax2021: number = 183260
